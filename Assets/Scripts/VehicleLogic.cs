...
namespace Game
{
    public class VehicleLogic : MonoBehaviour
    {
        ...
        public bool IsReverse() => vertical < 0;
        public bool IsMovingToward => vertical > 0;
        private bool IsRest() => vertical == 0 && horizontal == 0 || vertical == 0 && horizontal != 0;
        public bool IsMoving() => vertical != 0;
        private bool IsTurning() => horizontal != 0;
        ...
        public void UpdateControl(float x)
        {
            horizontal = x;
        }
        ...
        private void MovingBike()
        {
            ...
            rearWheelCollider.motorTorque = !IsReverse() ? currentLegPower * vertical : reversePower * vertical;
        ...
        private void TurningBike()
        {
            ...
            float nextAngle = temporaryFrontWheelAngle * horizontal;
