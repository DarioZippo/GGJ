...
namespace Pearl.Side2D
{
    ...
    [Serializable]
    public class Side2DControllerParameters
    {
        [Header("Gravity")]
        ...
        /// a Vector gravity
        [Tooltip("a multiplier applied to the character's gravity when going up")]
        public Vector2 vectorGravity = new(0, 1);
        ...
        public Vector2 MaxVelocity = new(100f, 100f);
        ...
        [ConditionalField("@UseSeparateDecelerationOnGround")]
        ...
        [ConditionalField("@UseSeparateDecelerationInAir")]
