...
namespace Pearl
{
    ...
    public static class Vector3Extend
    {
        ...
        public static Vector3 ChangeX(this Vector3 vector, in float x, in ChangeTypeEnum changeTypeTransform, Vector2 range = default)
        {
            range = range == Vector2.zero ? new Vector2(float.MinValue, float.MaxValue) : range;
        ...
        public static Vector3 ChangeY(this Vector3 vector, in float y, in ChangeTypeEnum changeTypeTransform, Vector2 range = default)
        {
            range = range == Vector2.zero ? new Vector2(float.MinValue, float.MaxValue) : range;
        ...
        public static Vector3 ChangeZ(this Vector3 vector, in float z, in ChangeTypeEnum changeTypeTransform, Vector2 range = default)
        {
            range = range == Vector2.zero ? new Vector2(float.MinValue, float.MaxValue) : range;
