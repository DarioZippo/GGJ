...
namespace Pearl
{
    public struct ParentStruct
    {
        ...
        public ParentStruct(Transform parent, WorldReference reference, bool worldPositionStays)
        {
            this.parent = parent;
    ...
    public static class TransformExtend
    {
        ...
        public static List<GameObject> FindObjectsWithTag(this GameObject parent, string tag)
        {
            return FindObjectsWithTag(parent.transform, tag);
        }

        public static GameObject FindObjectWithTag(this Transform parent, string tag)
        {
            List<GameObject> taggedGameObjects = FindObjectsWithTag(parent, tag);
            if (taggedGameObjects.IsAlmostSpecificCount())
            {
                return taggedGameObjects[0];
            }
            return null;
        }
        ...
        {
            return FindObjectWithTag(parent.transform, tag);
        }
        ...
        {
            SetParent(@this, parentStruct.parent, parentStruct.reference, parentStruct.worldPositionStays);
        }

        public static void SetParent(this Transform @this, Transform parent, WorldReference reference, bool worldPositionStays)
        {
        ...
        public static void ActiveAllChild(this Transform @this, bool active)
        {
            if (@this != null)
            {
                for (int i = @this.childCount - 1; i >= 0; i--)
                {
                    @this.GetChild(i).gameObject.SetActive(active);
                }
            }
        }
        ...
        public static bool TryGetChild(this Transform @this, Func<Transform, bool> filler, out Transform transform, bool includeYourSelf = false)
        {
            transform = GetChild(@this, filler, includeYourSelf);
        ...
        public static void SetRotation2D(this Transform @this, Vector2 direction, float initAngle = 0)
        {
            ...
            float aux = QuaternionExtend.CalculateAngle2D(direction.normalized, false, initAngle);
        ...
        public static void SetScale(this Transform @this, Vector3 newValue, ChangeTypeEnum changeTypeTransform, AxisCombined axisCombined = AxisCombined.XYZ)
        {
            if (@this)
            {
                ...
                @this.localScale = Vector3Extend.ChangeVector(scale, newValue, changeTypeTransform, axisCombined);
            }
        }
        ...
        public static void SetXScale(this Transform @this, float xScale, ChangeTypeEnum changeTypeTransform = ChangeTypeEnum.Setting)
        {
            if (@this)
            {
                @this.localScale  = @this.localScale.ChangeX(xScale, changeTypeTransform);
            }
        }
        ...
        public static void SetYScale(this Transform @this, float yScale, ChangeTypeEnum changeTypeTransform)
        {
            if (@this)
            {
                @this.localScale  = @this.localScale.ChangeY(yScale, changeTypeTransform);
            }
        }
        ...
        public static void SetZScale(this Transform @this, float zScale, ChangeTypeEnum changeTypeTransform)
        {
            if (@this)
            {
                @this.localScale = @this.localScale.ChangeZ(zScale, changeTypeTransform);
            }
        }
        #endregion
        ...
        public static void SetXPosition(this Transform @this, float xValue, ChangeTypeEnum changeTypeTransform, Vector2 range = default)
        {
            if (@this)
            {
                @this.position  = @this.position.ChangeX(xValue, changeTypeTransform, range);
            }
        }
        ...
        public static void SetYPosition(this Transform @this, float yValue, ChangeTypeEnum changeTypeTransform, Vector2 range = default)
        {
            if (@this)
            {
                @this.position = @this.position.ChangeY(yValue, changeTypeTransform, range);
            }
        }
        ...
        public static void SetZPosition(this Transform @this, float zValue, ChangeTypeEnum changeTypeTransform, Vector2 range = default)
        {
            if (@this)
            {
                @this.position  = @this.position.ChangeZ(zValue, changeTypeTransform, range);
            }
        }
        ...
        public static T GetComponent<T>(this GameObject @this, bool onlyChildren = false)
        {
            if (@this == null)
            {
                return default;
        ...
        public static bool TryGetChildInHierarchy<T>(this GameObject @this, out T result, bool onlyChildren = false)
        {
            result = GetChildInHierarchy<T>(@this.transform, onlyChildren);
            return result != null;
        }

        public static bool TryGetChildInHierarchy<T>(this Component @this, out T result, bool onlyChildren = false)
        {
            result = GetChildInHierarchy<T>(@this.transform, onlyChildren);
            return result != null;
        }
        ...
        public static Component GetChildInHierarchy(this GameObject @this, Type type, bool onlyChildren = false, bool includeInactive = true)
        {
            if (@this != null)
            {
                return @this.transform.GetChildInHierarchy(type, onlyChildren, includeInactive);
            }
            return null;
        }
