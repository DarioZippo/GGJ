...
namespace Pearl
{
    public static class Physics2DExtend
    {
        ...
        public static RaycastHit2D[] RaycastNonAlloc(Vector2 origin, Vector2 direction)
        {
        ...
        public static RaycastHit2D RayCast(Vector2 rayOriginPoint, Vector2 rayDirection, float rayDistance, LayerMask mask, bool drawGizmo = false, Color color = default)
        {
            if (drawGizmo)
            {
        ...
        public static RaycastHit2D[] RayCastAll(Vector2 rayOriginPoint, Vector2 rayDirection, float rayDistance, LayerMask mask, bool drawGizmo = false, Color color = default)
        {
            if (drawGizmo)
            {
                UnityEngine.Debug.DrawRay(rayOriginPoint, rayDirection * rayDistance, color);
