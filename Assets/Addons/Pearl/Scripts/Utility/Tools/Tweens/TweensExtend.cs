...
namespace Pearl.Tweens
{
    ...
    public static class TweensExtend
    {
        ...
        /// <param name = "isAutoKill">Does the tween have to destroy itself when it ends?</param>
        /// <param name = "values">The values ​​that the tween must reach</param>
        public static TweenContainer ScaleTween(this Transform transform, bool multiplyValue, float timeOrVelocity, bool isAutoKill, ChangeModes changeMode, params Vector3[] scaleVectors)
        {
            return ScaleTween(transform, multiplyValue, timeOrVelocity, isAutoKill, AxisCombined.XYZ, FunctionEnum.EaseIn_Quadratic, changeMode, scaleVectors);
        }
        ...
        /// <param name = "functionEnum">the function to soften the tween</param>
        /// <param name = "values">The values ​​that the tween must reach</param>
        public static TweenContainer ScaleTween(this Transform transform, bool multiplyValue, float timeOrVelocity, bool isAutoKill, FunctionEnum functionEnum, ChangeModes changeMode, params Vector3[] scaleVectors)
        {
            return ScaleTween(transform, multiplyValue, timeOrVelocity, isAutoKill, AxisCombined.XYZ, functionEnum, changeMode, scaleVectors);
        }
        ...
        /// <param name = "values">The values ​​that the tween must reach</param>
        public static TweenContainer ScaleTween(this Transform transform, bool multiplyValue, float timeOrVelocity, bool isAutoKill, AxisCombined axisCombined, ChangeModes changeMode, params Vector3[] scaleVectors)
        {
            return ScaleTween(transform, multiplyValue, timeOrVelocity, isAutoKill, axisCombined, FunctionEnum.EaseIn_Quadratic, changeMode, scaleVectors);
        }
        ...
        /// <param name = "functionEnum">the function to soften the tween</param>
        /// <param name = "values">The values ​​that the tween must reach</param>
        public static TweenContainer ScaleTween(this Transform transform, bool multiplyValue, float timeOrVelocity, bool isAutoKill, AxisCombined axisCombined, FunctionEnum functionEnum, ChangeModes changeMode, params Vector3[] values)
        {
            if (transform == null)
            {
                return null;
            ...
            {
                newValues[i] = multiplyValue ? Vector3.Scale(transform.localScale, values[i]) : values[i];
            }

            Vector4[] finalValues = ArrayExtend.ConvertNumbersAndVectors<Vector4>(newValues);
