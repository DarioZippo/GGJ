...
namespace Pearl
{
    ...
    public class EMailer : MonoBehaviour
    {
        ...
        public static bool SendAnEmail(SmtpClientData smtpClient, MessageData message, out string error)
        {
            ...
            {
                Debugging.LogManager.Log("Email success with port " + smtpClient.port + "!");
                return true;
            };
            ...
            {
                Debugging.LogManager.Log("Email error with port " + smtpClient.port + ": " + e.Message);
                return false;
            }
            finally
            {
                Debugging.LogManager.Log("Email sent!");
            }
