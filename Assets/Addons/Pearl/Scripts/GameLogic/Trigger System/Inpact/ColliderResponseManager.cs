...
namespace Pearl
{
    ...
    public class ColliderResponseManager : PearlBehaviour, IReset
    {
        ...
        [SerializeField]
        private StringInfoTriggerDictionary stayActions = null;
        #endregion
        ...
        public bool StayInpact(in GameObject colliderObj)
        {
            Trigger(colliderObj, TriggerType.Stay);
            return true;
        }
        ...
        {
            StringInfoTriggerDictionary actions = null;
            switch (triggerType)
            {
        ...
        {
            _listTriggeredActived?.Clear();
            _isEnable = true;
            _methodWaitForCount = 0;
            _auxIndexForWait = 0;
        }
        #endregion
    }
