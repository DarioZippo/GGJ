...
namespace Pearl.Debugging.ScreenVars
{
    public class DebugScreenManager : PearlBehaviour, ISingleton
    {
        ...
        private void AddPageIntern(Type page)
        {
            ...
            for (int i = 0; i < members.Length; i++)
            {
                ...
                GameObjectExtend.CreateGameObject<DebugScreenElement>(debugScreenElementPrefab, out DebugScreenElement debugElement, "Element", default, default, _debugScreenParent, WorldReference.World, false, false, false);
