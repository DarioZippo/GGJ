...
namespace Pearl.UI
{
    ...
    public class PearlSlider : Slider, IPearlSelectable, IFocusLayer
    {
        ...
        protected override void Start()
        {
            ...
            onValueChanged?.AddListener(ClampSliderValue);
        }
        ...
        protected override void OnDestroy()
        {
            ...
            onValueChanged?.RemoveListener(ClampSliderValue);
        }
        ...
        #region Private Fields
        private void ClampSliderValue(float newValue)
        {
            if (useStepSize && StepSize > 0)
            {
                float steppedValue = Mathf.Round(newValue / StepSize) * StepSize;
